...
def add_string_ascii_letter(a,b):
    """Summery: This function adds two strings together and returns the result.  The strings are first converted to their ascii values and then added together.  The result is then converted back to a string and returned.  This is just for fun, and is tecnically correct, and good for a laugh.
    It give you a letter, not a number.
...
#     """Summery: This function takes a string and converts it to its ascii values.  It then returns a list of the ascii values.
    
#     Args:
#         string (string): The string to be converted to ascii values.

#     Returns:
#         list: A list of the ascii values of the string.
